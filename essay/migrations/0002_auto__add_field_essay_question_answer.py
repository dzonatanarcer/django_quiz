...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Essay_Question.answer'
        db.add_column(u'essay_essay_question', 'answer',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Essay_Question.answer'
        db.delete_column(u'essay_essay_question', 'answer')
