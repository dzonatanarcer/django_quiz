...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QuestionTakes.question_take_time'
        db.alter_column(u'quiz_questiontakes', 'question_take_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

    def backwards(self, orm):

        # Changing field 'QuestionTakes.question_take_time'
        db.alter_column(u'quiz_questiontakes', 'question_take_time', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        u'quiz.questiontakes': {
            ...
            'question_take_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
