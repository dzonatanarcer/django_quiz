...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.seconds_to_answer'
        db.add_column(u'quiz_question', 'seconds_to_answer',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.seconds_to_answer'
        db.delete_column(u'quiz_question', 'seconds_to_answer')
